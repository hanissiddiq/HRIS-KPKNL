...
<body>
    <div class="salary-slip">
        <div class="header">
            ...
            <div class="company-logo">
                ...
                <img src="{{ public_path('HRIS-Logo.png') }}" alt="Logo" width="85">
            </div>
    ...
    <div class="total">
        ...
        <div>Total Potongan: <span class="total-deductions">{{ 'Rp.' . number_format($potongan, 2, ',', '.') }}</span>
        </div>
