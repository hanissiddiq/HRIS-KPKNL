...
<head>
    ...
    <link rel="stylesheet" crossorigin href="{{ asset('mazer/dist/assets/compiled/css/auth.css') }}">
</head>
...
<body>
    ...
    <div id="auth">
        <div class="row h-100">
            <div class="col-lg-12 col-12 vh-100 d-flex justify-content-center">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="index.html">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input id="name" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Full Name" class="form-control form-control-xl" />
                        ...
                        <!-- Email -->
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input id="email" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="Email" class="form-control form-control-xl" />
                            <div class="form-control-icon">
                        ...
                        <!-- Password -->
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input id="password" type="password" name="password" required autocomplete="new-password" placeholder="Password" class="form-control form-control-xl" />
                            <div class="form-control-icon">
                        ...
                        <!-- Confirm Password -->
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password" class="form-control form-control-xl" />
                            <div class="form-control-icon">
                                <i class="bi bi-shield-lock"></i>
                            </div>
